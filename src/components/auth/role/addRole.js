...
export default function AddRoleModal({ isModalOpen, handleOk, handleCancel }) {
        ...
        >
            <Form layout="vertical">
                <Row gutter={{ xs: 0, sm: 8, md: 16, lg: 16 }}>
                    ...
                    >
                        <Form.Item>
                            <BrannTitle text="Add Role" />
                        </Form.Item>
                        <Form.Item name="name" label="New Role">
                            <BrannInput placeholder="New Role" value={value} onChange={handleChange}/>
                        </Form.Item>
